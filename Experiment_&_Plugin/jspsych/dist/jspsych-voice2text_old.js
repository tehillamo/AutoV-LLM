var jsPsychcVoiceText = (function (jspsych) {
  ...
  class VoiceText {
   ...
   trial(display_element, trial) {
        ...
        var new_html = '<div class="voice_to_text" style ="background-color:#f2f1ed; width:300px; position:absolute;left:0%;top:5%;">'+
                       '<h5>When you are ready to be recorded, <br>press the recording button below</h1>' + 
                       //'<input name="" id="convert_text"></input>' + 
                       '<button id="click_record">Record</button>'+
                       '</div>'
        
        var prompt = '<div id="prompt" style = "width: 500px">' + trial.prompt + '</div>'
        var button = '<input type="button" id="continue-button" style = "position:relative;left:0%;margin-top:50%;" value="continue">'
        
        var ImgButton_1 = '<button type="submit" id = "button_image-1">'+
                          '<img src="' + trial.stimulus[0] + '" style = "height:150px; width:150px; margin:15px" id="image-response-stimulus-1"></img>'+
                          '</button>'
        var ImgButton_2 = '<button type="submit" id = "button_image-2">'+
                          '<img src="' + trial.stimulus[1] + '" style = "height:150px; width:150px; margin:15px" id="image-response-stimulus-2"></img>'+
                          '</button>'

        var green = '<div hidden id="choice_circle_green">you chose the GREEN circle</div>'
        var blue = '<div hidden id="choice_circle_blue">you chose the BLUE circle</div>'
