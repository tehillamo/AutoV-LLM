var jsPsychcVoiceText = (function (jspsych) {
  ...
  class VoiceText {
   ...
   trial(display_element, trial) {
    ...
    // a function to determine if the exp§eriemnt will run with keys or with buttons 
    //if(trial.choices == "jspsych.ParameterType.HTML_STRING"){
    ...
    //} if(trial.choices == "jspsych.ParameterType.KEYS"){
        // var stimulus_1 = '<div id = "button_image-2" style = "margin: 20px">'+
        // '<img src="' + trial.stimulus[0] + '" style = "opacity: .01;height:150px; width:150px; margin:15px" id="image-response-stimulus-1"></img>'+
        // '</div>'

        // var stimulus_2 = '<div id = "button_image-2" style = "margin: 20px">'+
        // '<img src="' + trial.stimulus[1] + '" style = "opacity: .01;height:150px; width:150px; margin:15px" id="image-response-stimulus-2"></img>'+
        // '</div>'
    ...
    //}
        ...
        var button = '<div><input disabled type="button" id="continue-button" style = "position:relative;left:0%;margin-top:20%;" value="continue"></div>'
        ...
        // display_element.innerHTML += stimulus_1; 
        // display_element.innerHTML += stimulus_2;
